...
module.exports = {
    ...
    ChangePasswordValidator: [
        ...
        body('newPassword')
            .notEmpty().withMessage("newPassword khong duoc de trong").bail()
            .isStrongPassword({
                minLength: 8,
                minLowercase: 1,
                minNumbers: 1,
            ...
            .custom((value, { req }) => {
                if (value === req.body.oldPassword) {
                    throw new Error("newPassword khong duoc giong oldPassword");
                }
                return true;
            })
    ],
    InventoryQuantityValidator: [
        body('product')
            .notEmpty().withMessage("product khong duoc de trong")
            .bail()
            .isMongoId().withMessage("product phai la ObjectId"),
        body('quantity')
            .notEmpty().withMessage("quantity khong duoc de trong")
            .bail()
            .isInt({ min: 1 }).withMessage("quantity phai la so nguyen duong")
            .toInt()
    ],
}
